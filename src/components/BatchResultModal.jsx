    ...
    <div className="modal-overlay">
      <div className="card" style={{ width: '100%', maxWidth: '500px', padding: '1.5rem' }}>
        ...
        <div style={{ display: 'flex', gap: '10px', marginBottom: '1.5rem' }}>
          ...
          >
            Négatif (-) <br/><small>Tout va bien</small>
          </button>
          <button 
            type="button"
          ...
          >
            Positif (+) <br/><small>Traitement requis</small>
          </button>
        </div>
        ...
        <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
          ...
          {mode === 'negative' && (
            <div className="p-3 bg-green-50 border border-green-200 rounded text-green-800 text-sm">
              ...
              <strong> Négatifs</strong> et validés <strong>APTE</strong>. 
              La prochaine visite sera calculée automatiquement (+6 mois).
            </div>
          )}
          ...
          {mode === 'positive' && (
            <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
              <div>
                ...
                <input 
                  className="input" placeholder="ex: Kystes d'amibes" 
                  value={parasite} onChange={(e) => setParasite(e.target.value)} 
                />
              </div>
              <div>
                <label className="label">Traitement prescrit</label>
                <input 
                  className="input" placeholder="ex: Metronidazole 500mg" 
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem' }}>
                ...
                <div>
                  ...
                  <input 
                    ...
                    value={retestDays} onChange={(e) => setRetestDays(Number(e.target.value))} 
                  />
                </div>
              </div>
