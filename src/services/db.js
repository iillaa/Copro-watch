  ...
  workers: [
    {
      ...
      next_exam_due: '2025-08-01',
    },
    {
      id: 2,
      full_name: 'Sarah Idrissi',
      national_id: '1002',
      phone: '0661123457',
      workplace_id: 1,
      department_id: 1,
      ...
      notes: '',
      last_exam_date: '2024-09-01',
      next_exam_due: '2025-03-01',
    },
    {
      id: 3,
      ...
      notes: '',
      last_exam_date: '2024-05-15',
      next_exam_due: '2024-11-15',
    },
    {
      id: 4,
...
export const db = {
  ...
  // --- WORKERS ---
  async getWorkers() {
    return this.getAll(STORES.WORKERS);
  },
  ...
  // --- EXAMS ---
  async getExams() {
    return this.getAll(STORES.EXAMS);
  },
  async saveExam(exam) {
  ...
  async getWaterAnalyses() {
    return this.getAll(STORES.WATER_ANALYSES);
  },
  ...
  async getDepartments() {
    return this.getAll(STORES.DEPARTMENTS);
  },
  async getWorkplaces() {
    return this.getAll(STORES.WORKPLACES);
  },
  async getWaterDepartments() {
    return this.getAll(STORES.WATER_DEPARTMENTS);
  },
  ...
  async importData(jsonString) {
    try {
      ...
      if (data.water_departments)
        await this.saveAll(STORES.WATER_DEPARTMENTS, data.water_departments);
      return true;
    } catch (e) {
