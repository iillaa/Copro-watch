...
4.  **Récupérer votre fichier** :
    ...
    *(Note : Cet APK est "non signé". Il s'installera sur la plupart des téléphones si vous activez "Sources inconnues", mais pour le Play Store, il faudra le signer).*
